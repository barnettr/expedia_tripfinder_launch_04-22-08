...
<div id="divTFContent" style="background-image:url(<%= background %>); background-repeat: no-repeat;top:0px;width:992px;height:1066px;position:relative;">
	...
	<script language="javascript" type="text/javascript">
        ...
        function getPricing(description,hotel,packageprice,hotellink,pkglink,category,location,region)
        {
            ...
            if (hotel != undefined)
            {
                var salelink = "http://10.95.1.5/daily/vacations/summerofadventure/sale/"+region+"/default.asp?dest="+location;
...
%>
	<%If reg = "US" Then%>
	<div id="within" style="font-family: Arial,sans-serif;font-size: 14px;font-weight: bold;color: #330000; position:absolute;left:95px;top:150px;">Within the U.S.</div>
	...
	<%Else%>
	<a href="finder.asp?category=<%= cat %>&region=US&friendly=<%= (numID-12) %>" style="text-decoration:none; cursor:pointer;"><div id="within" style="font-family: Arial,sans-serif;font-size: 14px;font-weight: bold;color: #330000; position:absolute;left:95px;top:150px;">Within the U.S.</div></a>
	<div id="beyond" style="font-family: Arial,sans-serif;font-size: 14px;font-weight: bold;color: #330000; position:absolute;left:315px;top:150px;">Beyond the U.S.</div>
	<%End If%>
<% 
    End If 
%>
